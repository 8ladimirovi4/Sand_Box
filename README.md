...
- `saveArticle()` - сохраняет одну статью в базу данных
- `saveAllArticles()` - сохраняет все статьи в базу данных
...
6. ✅ Каждая новость сохраняется в базу данных
7. ✅ Новости автоматически отправляются в Telegram канал (если настроен)
...
- Новости автоматически отправляются в Telegram канал
